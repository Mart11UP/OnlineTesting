...
namespace EpicTransport {
    public class Server : Common {
        ...
        public static Server CreateServer(EosTransport transport, int maxConnections) {
            ...
            //s.OnReceivedError += (id, exception) => transport.OnServerError.Invoke(id, exception); //¡Alerta! Solamente comenté esto así de huevos para evitar un error. Ni sé pa qué sirve. Si algo sucede, puede que aquí esté el problema jaja lol
